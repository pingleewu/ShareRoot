...
from traitsui.api import InstanceEditor,Item,View,HSplit,VSplit,Handler, StatusItem
from traitsui.menu import Action, MenuBar, ToolBar, Menu, Separator
...
def open_dialog():
    ...
    dlg = wx.FileDialog(None, "Choose a file", "", "", "*.txt;*.gz;*.lzma;*.dat", style=wx.FD_OPEN )
    rv = None
